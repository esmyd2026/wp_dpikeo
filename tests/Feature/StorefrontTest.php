...
class StorefrontTest extends TestCase
{
    ...
    public function test_root_shows_the_default_company_storefront(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertSee('id="bulkAddonSkip"', false)
            ->assertSee('Continuar sin adicionales')
            ->assertSee('customizerExtras = [];', false)
            ...
            ->assertSee('catalog-image-shell', false)
            ->assertSee('data-catalog-image', false)
            ->assertSee("document.addEventListener('error', event => settleCatalogImage", false)
            ->assertSee('image.naturalWidth > 0', false)
